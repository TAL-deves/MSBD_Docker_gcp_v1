...
import googlebtn from "../components/downloadApp/googlebtn.png"
import applebtn from "../components/downloadApp/5.png";
      ...
      <Grid container spacing={2}
       sx={{marginTop:"5rem"}}>
        <Grid item xs={12} lg={6} >
          ...
          <Routerlink to="/coursedemo" state={{ courseId: state.courseID}}
      ...
      marginTop:"1rem", display:"flex",alignItems:"center"}}>
        ...
        <Box>
          ...
          <InstructorInCourseDetails
                title={instructorState[0].title}
                instructor={instructorState[0].description_title1}
