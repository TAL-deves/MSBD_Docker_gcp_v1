...
const InstructorDetails = () => {
    ...
    useEffect(() => {
        fetch(`${process.env.REACT_APP_API_URL}/api/allcourses`)
          .then((res) => res.json())
          .then((data) => setCourses(data.data.courseData.coursesData));
        //  console.log(courses)
      }, []);
    return (
        <Box>
                <Box>
                <Typography variant="h4" sx={{paddingLeft:"40%", marginTop:"2%"}}></Typography>
    ...
    <Box
      ...
      >
        ...
        <Grid container  sx={{display:"flex",justifyContent:{xs:"center",md:"flex-start",lg:"flex-start"},paddingLeft:"10%"}}>
        ...
        <Grid sx={{marginLeft:"5%"}} item lg={2} md={6} sm={12}>
         ...
         <Box sx={{display:"flex",alignItems: "center"}}>
            <Box >
                ...
                <Avatar variant={"rounded"} alt="The image" src={state?.image} style={{
                width: "auto",
                height: "auto",
            }} />
            </Box>
         ...
         <Typography variant="h4" sx={{paddingLeft:"20%", marginTop:"2%"}}>Profile of {state?.title} 
         </Typography>
         <Typography  sx={{paddingLeft:"20%", marginTop:"2%"}}>{state?.description_title1}</Typography>
         <Typography variant="h5" sx={{paddingLeft:"20%", marginTop:"2%"}}>{state?.description} </Typography>
         </Grid>
    ...
    {/* </VideoGridWrapper> */}
      ...
      <Typography variant="h4" sx={{marginTop:"5rem",display:"flex",justifyContent:{xs:"center",sm:"center",md:"flex-start", lg:"flex-start"},alignItems:"center",justifyContent:"center"}}>Courses List of {state?.title}</Typography>
      <Grid spacing={4}>
                      ...
                      <CardActionArea>
                        ...
                        <CardContent>
                          ...
                          <Link
                            ...
                            style={textstyle}
                          >
                            <Button size="small" variant="contained" sx={{ marginTop: "3%", marginLeft:"27%",
